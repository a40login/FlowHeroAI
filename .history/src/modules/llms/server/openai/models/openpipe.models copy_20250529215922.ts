...
const _knownOpenPipeChatModels: ModelDescriptionSchema[] = [
  ...
  // OpenAI models: these work
  {
    ...
    interfaces: [LLM_IF_Chat, LLM_IF_Vision, LLM_IF_Fn, LLM_IF_Json],
  ...
  },
  {
    ...
    interfaces: [LLM_IF_Chat, LLM_IF_Fn],
...
// https://openpipe.ai/
// OpenPipe provides fine-tuned models via an OpenAI-compatible API.
// The models available depend on the user's OpenPipe project.
// This list is a placeholder for known models.

export const _knownOpenPipeModels: ModelDescriptionSchema[] = [

  // Placeholder for OpenPipe models
  {
    id: 'openpipe-model',
    label: 'OpenPipe Modell', // Übersetzt
    description: 'Ein über OpenPipe bereitgestelltes Modell (kann feinabgestimmt sein).', // Übersetzt
    contextWindow: 8192, // Default guess
    maxCompletionTokens: 4096, // Default guess
    trainingDataCutoff: 'Unbekannt', // Übersetzt
    interfaces: [LLM_IF_Chat, LLM_IF_Fn, LLM_IF_Vision], // Default guess
    chatPrice: { input: 0, output: 0 }, // Pricing depends on OpenPipe project
    benchmark: undefined, // Unknown
  },

  // ... add other known OpenPipe models here as needed
