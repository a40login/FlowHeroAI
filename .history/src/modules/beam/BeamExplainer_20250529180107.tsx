...
const beamSteps: ExplainerPage[] = [
  {
    ...
    // titleSquircle: true,
    mdContent: `
**Beam** ist eine Chat-Modalität in FlowHero, um mehrere KI-Modelle [gemeinsam](https://flow-hero.com/blog/beam-multi-model-ai-reasoning) einzusetzen.
...
![FlowHero BEAM Rays](https://flow-hero.com/app/journeys/beam/explainer-beam-scatter-1200px-alpha.png)
...
![FlowHero BEAM Rays](https://flow-hero.com/app/journeys/beam/explainer-beam-gather-1600px-alpha.png)
...
// Es gibt tiefgreifende Gründe, warum dieser Ansatz funktioniert, die wir [in unserem Blog](https://flow-hero.com/blog/introducing-beam) untersuchen.
//
// #### Beste Nutzung
